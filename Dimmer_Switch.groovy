    ...
    if (body !=null){
        ...
        switch(Action.toUpperCase()) { 
            ...
            case ["DIMMER"]:  //Usually referred to as Level in Hubitat
                ...
                //So we need to handle a non numeric condi
                if (isValidInteger(ActionValue) == true) {
                    ...
                    //ActionValue was non numeric so we have to assume the new value was a correct increment or decerement.
