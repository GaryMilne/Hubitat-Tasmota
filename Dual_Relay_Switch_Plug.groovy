    ...
    if (body !=null){
        ...
        switch(Action.toUpperCase()) { 
            ...
            case ["STATE"]:
                ...
                if (body?.POWER5) updateChild("5", body.POWER5.toLowerCase())
                if (body?.POWER6) updateChild("6", body.POWER6.toLowerCase())
                if (body?.POWER7) updateChild("7", body.POWER7.toLowerCase())
                if (body?.POWER8) updateChild("8", body.POWER8.toLowerCase())
                updateStatus("Complete:Success")
                break            
